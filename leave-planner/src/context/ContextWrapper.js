        ...
        case "push":
            ...
            if(Math.abs((payload.fromday-payload.todate)/(1000*60*60*24)) >= 2){
                ...
                for(var k=1;k<=j;k++){
                    ...
                    var incrementer = {
                        empid: payload.empid,description:payload.description,emptype:payload.emptype,teamName:payload.teamName,label:payload.label,id:payload.id,fromday:checkdate, todate:checkdate
                    }
        ...
        case "update":
            ...
            if(Math.abs((payload.fromday-payload.todate)/(1000*60*60*24)) >= 2){
                ...
                for(var newk=1;newk<=newj;newk++){
                    ...
                    var newincrementer = {
                        empid: payload.empid,description:payload.description,label:payload.label,emptype:payload.emptype,teamName:payload.teamName,id:payload.id,fromday:newcheckdate, todate:newcheckdate
                    }
